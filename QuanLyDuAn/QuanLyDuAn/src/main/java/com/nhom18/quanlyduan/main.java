...
public class main {
    ...
    public static void main(String arg[]) {
        NhanVien a1 = new NhanVienThuong("Ng vv a", GioiTinh.NAM, LocalDate.parse("26/11/2000", DateTimeFormatter.ofPattern(CAUHINH.PATTERN)), "afdd@", ChucVu.NHAN_VIEN_THUONG, 10000, 20);
        NhanVien a2 = new NhanVienThuong("Ng vv b", GioiTinh.NAM, LocalDate.parse("26/11/2000", DateTimeFormatter.ofPattern(CAUHINH.PATTERN)), "afdd@", ChucVu.NHAN_VIEN_THUONG, 10000, 20);
        NhanVien a3 = new LapTrinhVien("Ng vv c", GioiTinh.NAM, LocalDate.parse("26/11/2000", DateTimeFormatter.ofPattern(CAUHINH.PATTERN)), "afdd@", ChucVu.LAP_TRINH_VIEN, 10000, 20, 30000);
        NhanVien a4 = new NhanVienThuong("Ng vv d", GioiTinh.NAM, LocalDate.parse("26/11/2000", DateTimeFormatter.ofPattern(CAUHINH.PATTERN)), "afdd@", ChucVu.NHAN_VIEN_THUONG, 10000, 20);
        NhanVien a5 = new KiemThuVien("Ng vv e", GioiTinh.NAM, LocalDate.parse("26/11/2000", DateTimeFormatter.ofPattern(CAUHINH.PATTERN)), "afdd@", ChucVu.KIEM_THU_VIEN, 10000, 20, 7);
        NhanVien a6 = new ThietKeVien("Ng vv f", GioiTinh.NAM, LocalDate.parse("26/11/2000", DateTimeFormatter.ofPattern(CAUHINH.PATTERN)), "afdd@", ChucVu.THIET_KE_VIEN, 10000, 20, 25000);
        ...
        PhongBan c1 = new PhongBan("Ban 1", a2, a5, a4, a1);
        PhongBan c2 = new PhongBan("Ban 2", a2, a3, a2, a6);
